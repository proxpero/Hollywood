...
let config = TMDb.Configuration(
    baseURL: URL(string: "https://api.themoviedb.org/3")!,
    apiKey: "4559e8696247b2066f5ab358314210d1"
)
let tmdb = TMDb(configuration: config)

let url = tmdb.movie.popular()
let resource = Resource<[TMDb.Movie.ListResultObject]>(url: url)
